...
a persistence unit " eva62PadillaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in " eva62Padilla/pom.xml":
...
artifact (" eva62Padilla.war") is already built. You can build
